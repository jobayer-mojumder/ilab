					...
					<div class="col-xs-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<h4 class="box-name">Module Edit</h4>
							</div>
							...
							<?php } ?>
							<form class="form-horizontal" method="post" action="<?=site_url('user_admin/module_edit/'.$results->m_id)?>" enctype="multipart/form-data">
								<div class="box-body">

									<div class="form-group">
										<label for="title" class="col-sm-2 control-label">Module Name</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" id="name" name="name" placeholder="Name Here" required value="<?=$results->m_name?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="sub" name="sub" placeholder="Sub Parent Here" value="<?=$results->m_sub?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="parent" name="parent" placeholder="Parent Here" required value="<?=$results->m_parent?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											<select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="status" id="status">
												<option value="1" <?php if($results->m_status==1) echo "selected";?> >Yes</option>
												<option value="0" <?php if($results->m_status==0) echo "selected";?>>No</option>
											</select>
										</div>
									</div>
