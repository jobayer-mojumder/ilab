        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <form method=post action="<?=site_url('ispadmin/ipauth_edit/'.$ipauth->id)?>" enctype="multipart/form-data" name="myform" id="myform">
                    <div class="form-group">
                      <label>IP address</label>
                      <input class="form-control" type=text name="ipauth"  value="<?=$ipauth->ipauth?>"   required >

                    </div>
                    <div class="form-group " >
                      <label>Status</label>
                      <select name="status" required class="form-control">
                       <option value=1 <?php if($ipauth->status)echo "selected";?>>Yes</option>
                       <option value=0 <?php if(!$ipauth->status)echo "selected";?>>No</option>
                     </select>
